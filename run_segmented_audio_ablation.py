...
This is a shared-feature, multi-model version of the existing
``Label-free-CBM-Audio-amine/scripts/segmented_cbm_inference.py``.  It preserves
that script's windowing, concept normalization, and mean/max/LME pooling while
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=Path,
        help=(
            "Canonical bundle produced by scripts/build_google_drive_bundle.py. "
